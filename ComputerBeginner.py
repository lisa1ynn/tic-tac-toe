...
# starts a game against the beginner computer as player with X
    def playAgainstBeginnerX(self, playerX, computer):
        ...
        if board.isWinner() != True and board.isDraw() != True:
            ...
            if board.isWinner():
                ...
                # if game is a draw
                print(f"{playerX.getName()}, you little {veggies[random.randint(0, 55)]}, "
                      f"YOU COULDN'T BEAT A COMPUTER SIMULATED BEGINNER!...this is a DRAW!!!")
    ...
    def playAgainstBeginnerO(self,playerX, computer):
